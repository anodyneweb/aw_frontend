...
//   }
// ];
let StationComponent = class StationComponent {
    constructor(route, router, alertService, authenticationService, userService, StationService) {
        this.route = route;
        this.router = router;
...
], StationComponent.prototype, "paginator", void 0);
tslib_1.__decorate([
    ViewChild(MatSort, { static: true })
], StationComponent.prototype, "sort", void 0);
